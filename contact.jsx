...
export default function Contact() {
  return (
    <>
      ...
      >
        <div class="profile-card w-[500px] rounded-md shadow-xl overflow-hidden z-[300] relative cursor-pointer snap-start shrink-0 bg-white flex flex-col items-center justify-center gap-3 transition-all duration-300 group ">
          ...
          <div class="headings *:text-center *:leading-4">
            ...
            <p class="text-sm font-semibold text-[#434955]">DEVELOPER/STUDENT</p>
          </div>
          <div class="w-full items-center justify-center flex">
            <ul class="flex flex-col items-start gap-2 has-[:last]:border-b-0 *:inline-flex *:gap-2 *:items-center *:justify-center *:border-b-[1.5px] *:border-b-stone-700 *:border-dotted *:text-xs *:font-semibold *:text-[#434955] pb-3">
              ...
              <li>
                ...
                <p>Rajaram compound utkarsh nagar tp road bhandup(w)</p>
              </li>
            </ul>
          </div>
